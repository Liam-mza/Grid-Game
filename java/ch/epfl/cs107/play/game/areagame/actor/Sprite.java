...
public class Sprite extends ImageGraphics {
    ...
    public Sprite(String name, float width, float height, Positionable parent,Vector anchor) {
        super(ResourcePath.getSprite(name), width, height, null, anchor, 1.0f, -parent.getPosition().y);
        setParent(parent);
        depthCorrection = 0;
    }
    @Override
